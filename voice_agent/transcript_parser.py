...
def get_patient_data_from_transcript(call_transcript: str, structured_output: dict):
    ...
    openai_chatcompletion_args = {
        ...
        "messages": [
            {
                "role": "system",
                "content": f"You will be provided an unstructured call transcript between a patient  \
                    intake bot agent and a human. You will also be given an output JSON shape with null values. \
